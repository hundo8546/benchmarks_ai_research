...
np.save("/workspace/benchmarks_ai_research/routing/biggan_clip_val_idx.npy", val_idx)
...
# Save model
joblib.dump((clf, scaler), "/workspace/benchmarks_ai_research/routing/biggan_clip_classifier.pkl")
