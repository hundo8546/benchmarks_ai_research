...
df = pd.read_csv("/workspace/benchmarks_ai_research/routing/sd14_merged_dataset.csv")
...
np.save("/workspace/benchmarks_ai_research/routing/sd14_bandit_val_paths.npy", val_paths)
...
joblib.dump((model, scaler), "/workspace/benchmarks_ai_research/routing/sd14_bandit_model.pkl")
